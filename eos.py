...
class EOS_Table(object):
    ...
    def _set_arrays(self):
        ...
        self._nu_dw  = self._f_nu_dw(R)
        self._alpha  = self._f_alpha(R)
        self._alpha_dw = self._f_alpha_dw(R)
        self._leverarm = self._f_leverarm(R)
    ...
    @property
    def alpha_dw(self):
        return self._alpha_dw

    @property
    def leverarm(self):
        return self._leverarm
...
class LocallyIsothermalEOS(EOS_Table):
    ...
    def _f_alpha_dw(self, R):
        return self._alpha_dw
    
    def _f_nu_dw(self, R):
        return self._alpha_dw * self._f_cs(R) * self._f_H(R)

    def _f_leverarm(self,R):
        return self._leverarm
...
class SimpleDiscEOS(EOS_Table):
    ...
    """
    def __init__(self, star, alpha_t, alpha_dw, leverarm, mu=2.33, K0=0.01):
...
class IrradiatedEOS(EOS_Table):
    ...
    args:
        ...
        accrete : Whether to include heating due to accretion,
                  default=True
    """
    def __init__(self, star, alpha_t, alpha_dw, leverarm, Tc=10, Tmax=1500., mu=2.4, gamma=1.4,
                 kappa=None,
